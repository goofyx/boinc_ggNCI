<?php
	...
	$katalog_sr = $katalog_domowy_dane."/sample_results_doAnalizy";
	$katalog_sr_NAS4 = $katalog_domowy_dane."/sample_results_doAnalizy_NAS4";
	
	$katalog_archives_results_NAS4 = $katalog_domowy_dane."/archives_results_NAS4";
