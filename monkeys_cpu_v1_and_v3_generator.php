<?php
  ...
  echo "START MONKEYS_cpu_".$nr_aplikacji."_GENERATOR\n";
  ...
  if ($wynik->num_rows > 0) 
  {
    ...
    if ($nie_wyslanych["count(1)"] < $prog_generowania ){    
      system( "php /home/boincadm/gcc/monkeys_cpu_v1_and_v3_db_wu_2.php ".$nr_aplikacji );  
    } else {
      echo "Ilosc WU dla Monkeys_cpu_".$nr_aplikacji.":".$nie_wyslanych["count(1)"]."\n";    
    }        
  }
