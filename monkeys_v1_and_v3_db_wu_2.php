<?php
  ...
  $plik_lock = "/home/boincadm/gcc/pid_goofyxGrid/monkeys_".$nr_aplikacji."_db_wu_2.lock";
...
//	echo "  ".$nazwa_pliku_wu."\n ";
	...
	exec( $polecenie );
	$polecenie = "./bin/create_work --delay_bound ".$waznosc_wu_sekundy." -appname monkeys_".$nr_aplikacji." -wu_name ".$nazwa_pliku_wu." --max_error_results 1 --max_success_results 1 -wu_template templates/".$nazwa_pliku_templatki.$ilosc_znakow." -result_template templates/monkeys_".$nr_aplikacji."_result ".$nazwa_pliku_wu;
	exec( $polecenie );
